    ...
    build: {
        lib: {
            entry: {
                ...
                componentContextModelDimension: fileURLToPath(new URL('src/component/context/model/dimension/index.ts', import.meta.url)),
                componentContextModelDimensionHierarchy: fileURLToPath(new URL('src/component/context/model/dimension/hierarchy/index.ts', import.meta.url)),
